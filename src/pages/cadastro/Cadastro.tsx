...
function Cadastro() {
  ...
  const navigate = useNavigate(); //Redireciona pra qualquer rota

  //Estado para controlar o Loader (animação de careegamento )
  ...
  //useEffect que vai controlar o redirecionamento de Login
  ...
  //Funcao de atualização do estado usuario
  ...
  //Funçcao de atualização do estado confirmarSenha
  function handleConfirmarSenha(e: ChangeEvent<HTMLInputElement>){
    setConfirmarSenha(e.target.value)
  }

  //Função Enviar os dados para o Backend (Submit)
  async function cadastrarNovoUsuario(e: SyntheticEvent<HTMLFormElement>){
    ...
    if(confirmarSenha === usuario.senha && usuario.senha.length >= 8){
      ...
      try{
        ...
        ToastAlerta('Usuario Cadastrado com sucesso!');
